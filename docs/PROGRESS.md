...
| The fall-through visible in the record | phase done-when, line 2 | **The secondary enabled and a night run with it.** The operator disabled it on 2026-08-25 so a cold local model halts rather than billing. Re-enabling it is a spending decision and it is theirs |
